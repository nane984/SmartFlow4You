...
export const DASHBOARD_MODULES: DashboardModule[] = [
    {
        id: "tender-definitions",
        to: "/tenders/definitions",
        title: "Tender definitions",
        description: "Automated rules to discover public procurements and import matching tenders.",
        accent: "from-indigo-500/10 to-violet-500/5 ring-indigo-200/60",
